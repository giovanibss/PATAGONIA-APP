      ...
      <div className="flex items-center gap-3">
        ...
        {resumo != null && (
          typeof resumo === "string"
            ...
            : <span className="shrink-0">{resumo}</span>
        )}
        {onExcluir && (
          <button
            onClick={onExcluir}
...
export default function App() {
  ...
  const [cardFin, setCardFin] = useState({});
  const alternarFin = (k) => setCardFin((m) => ({ ...m, [k]: !m[k] }));
  ...
  return (
    <div className="relative min-h-screen w-full font-sans text-[#fbebd9]">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:pl-[104px] pb-8 sm:pb-12">
          ...
          <div className="space-y-3">
            ...
            <div className={`${vidro} rounded-2xl p-5 border-fuchsia-400/25`}>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="min-w-0">
                  <div className="font-titulo text-[11px] uppercase tracking-[0.2em] text-fuchsia-300/85 mb-1">
                    Orçamento da viagem
                  </div>
                  <div className="font-titulo text-4xl sm:text-5xl font-bold tracking-wide leading-none">
                    <Editavel
                      valor={estado.orcamento || 0}
                      numero
                      prefixo="US$ "
                      onChange={(v) => setEstado((s) => ({ ...s, orcamento: v }))}
                      className={temOrcamento ? "" : "text-[#fbebd9]/35"}
                    />
                  </div>
                </div>
                <div className="text-right shrink-0">
                  {temOrcamento ? (
                    <>
                      <div className="font-titulo text-[11px] uppercase tracking-[0.2em] text-[#fbebd9]/60 mb-1">
                    ...
                    <div className="text-sm text-[#fbebd9]/55 max-w-[15rem] leading-snug">
                      Toque no valor para definir seu orçamento. Só então a folga faz sentido.
                    </div>
                  )}
                </div>
              </div>
              ...
              {temOrcamento && (
                <div className="mt-4">
                  <div className="h-2.5 rounded-full bg-[#fbebd9]/10 overflow-hidden flex">
            ...
            <CardRetratil
              ...
              aberto={cardFin.situacao === true}
              onAlternar={() => alternarFin("situacao")}
            >
            ...
            {/* 2 · Cronograma das faturas */}
            <CardRetratil
              vidro={vidro}
              titulo="Cronograma das faturas"
              resumo={fvd(faturas.lista.reduce((t, f) => t + f.total, 0) + faturas.semMes)}
              aberto={cardFin.faturas === true}
              onAlternar={() => alternarFin("faturas")}
            >
            ...
            {/* 3 · Hospedagem no total */}
            <CardRetratil
              vidro={vidro}
              titulo="Hospedagem no total"
              resumo={fvd(totalHosp)}
              aberto={cardFin.hospedagem === true}
              onAlternar={() => alternarFin("hospedagem")}
            >
